...
<body>
    ...
    <section id="shopping">
        ...
        <div class="product" data-id="1" data-price="20">
            <img src="https://www.mychoize.com/mychoize-live/current/files/fleets/Maruti_Ertiga_Hybrid.jpg" alt="Product 1">
            <h2>Maruti Ertiga </h2>
            <p>Rs.1,50,000</p>
        ...
        <div class="product" data-id="3" data-price="35">
            <img src="https://www.mychoize.com/mychoize-live/current/files/fleets/Mahindra_XUV_300.jpg" alt="Product 3">
            <h2>Mahindra TUV 300</h2>
            <p>Rs.95,000</p>
            <button class="add-to-cart">Add to Cart</button>
        </div>
        ...
        <div class="product" data-id="4" data-price="15">
            <img src="https://www.mychoize.com/mychoize-live/current/files/fleets/Hyundai_Creta.jpg" alt="Product 4">
            <h2>Hyundai Creta</h2>
            <p>Rs.75,000</p>
            <button class="add-to-cart">Add to Cart</button>
        </div>
        ...
        <div class="product" data-id="6" data-price="100">
            <img src="https://www.mychoize.com/mychoize-live/current/files/fleets/Toyota_Innova_Crysta.jpg" alt="Product 6">
		...
		<div class="product" data-id="5" data-price="20">
    		<img src="https://heritagecabs.in/assets/frontend/images/about/mercedes-luxury-car-rental-jaipur.webp" alt="Product 7">
...
<!-- Repeat the structure for each additional product -->
		<div class="product" data-id="6" data-price="20">
    		<img src="https://www.mychoize.com/mychoize-live/current/files/fleets/Maruti_Ciaz.jpg" alt="Product 6">
    		<h2>Maruti Ciaz</h2>
    		<p>Rs.80,000</p>
    		<button class="add-to-cart">Add to Cart</button>
		</div>
		...
		<div class="product" data-id="7" data-price="30">
    		<img src="https://www.mychoize.com/mychoize-live/current/files/fleets/Mahindra_Scorpio.jpg" alt="Product 7">
...
<!-- Product 9 -->
		<div class="product" data-id="9" data-price="80">
    		<img src="https://www.mychoize.com/mychoize-live/current/files/fleets/Mahindra_XUV_300.jpg" alt="Product 9">
    		<h2>Mahindra TUV 300</h2>
    		<p>Rs.85,000</p>
    		<button class="add-to-cart">Add to Cart</button>
		</div>
		<div class="product" data-id="10" data-price="30">
    		<img src="https://bagzpack.s3.amazonaws.com/car-imgs/bbb67231-fd86-4758-8136-9a4ec2959779/IMG/1654000017671.jpg" alt="Product 8">
    		<h2>Hyundai Venue</h2>
    		<p>Rs.90,000</p>
    		<button class="add-to-cart">Add to Cart</button>
		</div>
...
<!-- Product 9 -->
		<div class="product" data-id="11" data-price="150">
	    	<img src="https://onroadz.com/wp-content/uploads/2023/06/Swift-Dzire-Car-Rental.png" alt="Product 9">
	    	<h2>Swift Dezire</h2>
	    	<p>Rs.85,000</p>
	    	<button class="add-to-cart">Add to Cart</button>
		</div>
		<div class="product" data-id="12" data-price="450">
    		<img src="https://bagzpack.s3.amazonaws.com/car-imgs/68ea80da-f61b-4333-a4ed-ebae07c63893/IMG/1644666308819.png" alt="Product 9">
    		<h2>Mahendra XUV 500</h2>
    		<p>Rs.65,000</p>
    		<button class="add-to-cart">Add to Cart</button>
		</div>
		<div class="product" data-id="13" data-price="175">
    		<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS5rau_jxLi26qDgpqKD_jDJQPFCHvQlpJOEw&usqp=CAU" alt="Product 9">
    		<h2>Audi R8 </h2>
    		<p>Rs.1,50,500</p>
    		<button class="add-to-cart">Add to Cart</button>
		</div>
